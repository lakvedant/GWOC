...
const AboutUsBanner = () => {
    return (
        <div className="w-full bg-amber-50 overflow-hidden">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div className="rounded-xl overflow-hidden shadow-xl relative">
                        <div className="absolute inset-0 bg-amber-900/10 z-10 pointer-events-none"></div>
                        ...
                        {/* Decorative Elements */}
                        <div className="absolute -bottom-6 -left-6 w-12 h-12 bg-amber-200 rounded-full z-0"></div>
                    ...
                    <div className="flex flex-col space-y-6 max-w-lg">
                        <h2 className="text-3xl font-bold text-amber-900">
                            ...
                            <span className="block text-amber-600 mt-1">Baked with Love Since 1987</span>
                        </h2>
                        ...
                        <div className="pt-4">
                            <a
                                href="/about"
                                className="inline-flex items-center px-6 py-3 bg-amber-600 hover:bg-amber-700 text-white rounded-full transition-colors shadow-md group"
                            >
            ...
            <div className="hidden lg:block absolute -bottom-16 left-10 w-48 h-48 bg-amber-100 rounded-full opacity-30 blur-xl"></div>
            <div className="hidden lg:block absolute top-10 right-10 w-32 h-32 bg-amber-100 rounded-full opacity-30 blur-xl"></div>
        </div>
    );
};
